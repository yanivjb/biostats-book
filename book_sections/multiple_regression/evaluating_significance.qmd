...
- With Type I sums of squares, I wrongly conclude that anther-stigma distance is associated with `prop_hybrid` if  `asd_mm` entered first. This is because the p-value is computed before acounting for the other terms.   
