## • 20. Multiple Regression in R {.unnumbered #multiple_regression_R_workflow}
...
While we see some association among predictors, these are just on the edge at which we start to take notice. I don't think we're fully in the danger zone yet.  
