...
3. **Find, explain and interpret summaries of the spread of a numeric variable.**  
   - Understand the mathematics behind these summaries and calculate them manually.  
   - Combine dplyr's `summarise()` function with data summary functions (e.g. `mean()`, `median()`, `IQR()`, `sd()`, `var()`) to find standard summaries of the variability and central tendancy.  
