...
<article class="drop-cap">Science relies on the collection and analysis of data to understand the  world. Data are the backbone of all scientifically informed decisions. But data on it's own is just a pile pf numbers. We must analyze data and make sense of it. Here, I introduce tools for the standard scientific tasks of organizing, exploring, and dealing with data. Throughout we focus on how to do this reproducible.  </article> 
