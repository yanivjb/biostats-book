## • 11. The frogs {.unnumbered #the_frogs}
...
**Motivating Scenario:** We introduce the biological system and dataset that we will use to learn about permutation tests. You also wouldn't mind a little refresher on sampling, uncertainty, bootstrapping, and null hypothesis significance testing.

**Learning Goals: By the end of this section, you should:**

1.  **Know enough about the biology and dataset presented to be ready for the next sections.**

2. **Remember how to specify a null and alternative hypothesis**   

3. **Remember how we use the [`infer`](https://infer.netlify.app/) package to:**
...
There are plenty of reasons to choose your partner carefully. In much of the biological world  a key reason is "evolutionary fitness" -- presumably organisms evolve to choose mates that will help them produce more (or healthier) offspring. This could, for example, explain Kermit's resistance in one of the [more complex love stories of our time](https://www.insider.com/miss-piggy-and-kermit-relationship-timeline-2018-12), as frogs and pigs are unlikely to make healthy children.   

:::aside
In fact they will form fewer hybrids by mating than will *parviflora* and *xantiana*.
:::

To evaluate this idea @swierk2019, identified a male's top choice out of two female wood frogs and then had them mate with the preferred or the nonpreferred female and counted the number of hatched eggs.  The raw data  are available [here](https://raw.githubusercontent.com/ybrandvain/biostat/master/data/Swierk_Langkilde_BEHECO_1.csv)
...
#| code-fold: true
#| code-summary: "Loading, formatting, and plotting the data"
#| column: margin
#| label: fig-frogdata  
...
How  do we summarize this variation down to a single test statistic? A high-level summary could be the difference in mean hatched eggs between the preferred and non-preferred mating groups. We could calculate this as 345.11 - 413.93 = `r 345.11 - 413.93`. But I want to remind you how to do this with the [`infer`](https://infer.netlify.app/) package as we will be using it throughout this section: 
...
kable(bind_rows(ci_preferred,ci_nonpreferred,ci_diff)|>
        mutate_all(round)|>
