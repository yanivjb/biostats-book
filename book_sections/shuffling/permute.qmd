...
:::aside
**How many permutations?** There's no strict rule for the number of permutations. It's a trade-off between computational time and the precision of your p-value.A good starting point is five thousand permutations, but one thousand permutations are usually enough if the permuation is taking a while.
:::
