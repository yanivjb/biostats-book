### • 2. Many explanatory vars {.unnumbered #many_explanatory}
...
**Alternative formats:** 🎥 [Watch](https://drive.google.com/file/d/1XfIfyobC3x5x89HHdj6LEXOyPR7aav9E/view?usp=sharing) &nbsp;·&nbsp; 🎧 [Listen](../../audio/intro_to_r/intro_to_ggplot/many_explanatory.mp3)
:::
...
We saw that the number of pollinator visits increased with petal size and was greater for pink than white flowers. However, visualizing a response variable as a function of its multiple explanatory variables  together can clarify the patterns.  
...
#| echo: false
#| column: margin
include_graphics("../../figs/intro_to_r/intro_to_ggplot/multexplain.png")
```
...
**Interpretation:**     Returning to the motivating question, we see that visitation increases with both  petal area (positive slope) and pink petals (the red line is higher than the blue line). Later in the term, we will address this question more rigorously.     
...
#| echo: false
#| label: "fig-themoon"
#| fig-cap: "Using *small multiples* to show the phases of the moon over a month. From [this link](https://medium.com/@blakewilliford/information-design-9-29-ee995efb584e)"
...
[Edward Tufte](https://en.wikipedia.org/wiki/Edward_Tufte), a major figure in the field of data visualization, popularized the concept of [small multiples](https://en.wikipedia.org/wiki/Small_multiple). Small multiples show data with the same structure across various comparisons. Tufte argued that such visualizations can help our eyes make powerful comparisons (see quote above). For example,  the lunar phase can be well visualized by using small multiples (@fig-themoon).  
