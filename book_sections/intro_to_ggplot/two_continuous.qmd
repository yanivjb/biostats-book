### • 2. Two continuous variables {.unnumbered #two_continuous}
...
**Alternative formats:** 🎥 [Watch](https://drive.google.com/file/d/11Jq_v0xx6SJDp9LitqlUGo15dQfFC6Sn/view?usp=sharing) &nbsp;·&nbsp; 🎧 [Listen](../../audio/intro_to_r/intro_to_ggplot/two_continuous.mp3)
:::
...
#| echo: false
#| column: margin
include_graphics("../../figs/intro_to_r/intro_to_ggplot/clarkia_sketch_twocont.png")
```
...
**Take care not to lose data when transforming:** The log of any number less than or equal to zero is undefined. To avoid losing these data points, I transformed the data as `log(x+1)` with the `"log1p"` transformation. If the data were all greater than zero, I could have used the `log` `log10` or `sqrt` transform.
