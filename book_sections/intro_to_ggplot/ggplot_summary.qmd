...
**Alternative formats:** 🎥 [Watch](hhttps://drive.google.com/file/d/15jr5pujI3OedKNNW7mNP1gawlrsedK4e/view?usp=sharing) &nbsp;·&nbsp; 🎧 [Listen](../../audio/intro_to_r/intro_to_ggplot/ggplot_summary.mp3)
:::
...
:::tutor
Please interact with this custom chatbot ([**ChatGPT link here**](https://chatgpt.com/g/g-681d8901c5bc819195bfa3ad35a99030-intro-to-ggplot-tutor), [**Gemini link here**](https://gemini.google.com/gem/1EY7xo6SLM90pfx2yeYFQGy_DI-bb2Hq1?usp=sharing)) I have made to help you with this chapter. I suggest interacting with at least ten back-and-forths to ramp up  and then stopping when you feel like you got what you needed from it. 
:::
...
```{webr-r}
# uncomment line below for column names & class
# glimpse(ril_data)
...
As you can see the bar's color is the standard dark grey. The lines around the bars are reddish. This is because we mapped the variable "green" onto color. Instead keep it out of an `aes()` call. Also be sure to note the difference between `color` and `fill` arguments.
...
- **[`geom_histogram()`](https://ggplot2.tidyverse.org/reference/geom_histogram.html)** *([ggplot2](https://ggplot2.tidyverse.org/))*: Bins a continuous variable and shows counts per bin.  
- **[`geom_density()`](https://ggplot2.tidyverse.org/reference/geom_density.html)** *([ggplot2](https://ggplot2.tidyverse.org/))*: Shows a smoothed distribution of a continuous variable.  
- **[`geom_boxplot()`](https://ggplot2.tidyverse.org/reference/geom_boxplot.html)** *([ggplot2](https://ggplot2.tidyverse.org/))*: Summarizes a continuous variable's distribution with a box-and-whisker plot.  
- **[`geom_smooth()`](https://ggplot2.tidyverse.org/reference/geom_smooth.html)** *([ggplot2](https://ggplot2.tidyverse.org/))*: Adds a trendline (e.g., linear or loess) to a plot.  
...
- **[`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.html)** *([ggplot2](https://ggplot2.tidyverse.org/))*: Saves the most recent (or a specified) ggplot to a file.  
- **[`ggplotly()`](https://plotly.com/ggplot2/)** *([plotly](https://plotly.com/r/))*: Converts a ggplot object into an interactive plot with hover, zoom, and pan.  
:::
...
- **[`plotly`](https://plotly.com/r/)**: Turns a ggplot into an interactive, hoverable/zoomable plot via [`ggplotly()`](https://plotly.com/ggplot2/).
:::
...
- [ggplot2 Part 1: Introduction to Plotting (STAT 545 Episode 5-A)](https://www.youtube.com/watch?v=cqcQT44mJTM&list=PLC0dGnLDoE7F7TenUb_nn45W1203IhqyX&index=2): From Stat454.    
...
Data often contain strange outliers, ambiguous patterns, or otherwise interesting individual points. When I run into these issues during exploratory data analysis I often want to know more about individual data points. To do so, I make interactive graphs with the [`ggplotly()`](https://plotly.com/ggplot2/) function in the [`plotly`](https://plotly.com/r/) package. 
