### • 2. A continuous variable {.unnumbered #one_continuous}
...
**Alternative formats:** 🎥 [Watch](https://drive.google.com/file/d/1MIKsbWPntU_B4NgK2DW6oHp4JvgsE_hc/view?usp=sharing) &nbsp;·&nbsp; 🎧 [Listen](../../audio/intro_to_r/intro_to_ggplot/one_continuous.mp3)
:::
...
The resulting plot shows that most plants get zero visits, but some get more than seven visits! 
...
**Interpretation:**     Returning to our motivating questions, we see that many plants receive no visits, but this distribution is skewed with some plants getting lots of visits.  
