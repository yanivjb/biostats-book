# 15. Comparing two means {.unnumbered #two_ts}
...
:::aside
**Remmember, correlation is not causation!**  We usually want to know the cause (e.g., “Will a vaccine help or hurt?”), but we're often stuck with associations (e.g., “What’s the difference between vaccinated and unvaccinated people?”). Causal claims require careful experiments or other formal approaches to causal inference.
:::
