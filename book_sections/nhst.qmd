...
2. You are told results are "statistically significant" or they have some given p-value, and we want to know what that means.
...
```{r}
#| fig-cap: "Dont take it from me. Here's a TikTok  from professor [Christina Knudson](https://cknudson.com/) at St. Thomas."
#| echo: FALSE
#| column: margin
#| out-width: "100%"
#| eval: false
