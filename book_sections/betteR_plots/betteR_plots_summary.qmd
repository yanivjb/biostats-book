...
- **[`plot_annotation()`](https://patchwork.data-imaginist.com/reference/plot_annotation.html)** In the [`forcats`](https://forcats.tidyverse.org/) package: Adds overall titles and panel tags (e.g., A, B, C) to a combined figure.  
...
**[`ggblend`](https://mjskay.github.io/ggblend/)**: A ggplot extension for blending and composing overlapping layers. This is useful when default there are a lot of overlapping points in different categories. 
