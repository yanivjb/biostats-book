## • X2. Tools for BetteR plots {.unnumbered #plotting_tools} 
...
3.  **Leverage modern tools to accelerate your workflow** by:
...
4.  **Know how and when to ask people for help** by preparing a clear, concise question with a minimal reproducible example.
...
**Don't trust generative AI to be correct** These things are bullshitters. They don't understand things. They are written to please us. I could go on about the limitations of LLM's - but I love them for making plots because it is so easy to see if they worked (does the plot look how I wanted it to) or not.
