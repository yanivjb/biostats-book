...
But how do we find the null sampling distribution? One way, known as **permutation**, generates a null distribution directly from the data by randomly shuffling the explanatory variable labels across observations. Because this breaks any true relationship between variables, the resulting sampling distribution of permutations characterizes expectations under chance alone. We can then generate a p-value by comparing our test statistic to this empirically generated (permuted) null distribution.
