...
The degrees of freedom reflect the number of observations that can vary before all values are determined, which is related to the uncertainty in our estimate. So, the more degrees of freedom, the more certainty! As such, tails become less "fat," and the t-distribution looks more and more like the standard normal (Z) distribution as the degrees of freedom increase (@fig-tvz).
...
:::fyi
**You may see Z-tests in the literature.** With samples, a Z tests are not 100% correct, because we never have a population. But, Z-tests are often "right-ish". As sample sizes get large, the t- and Z- distributions converge. This is good enough for me. My view is that we should be worried quite worried about big problems that will mislead us, and less worried about modest approximations that are close to but not exactly right.
