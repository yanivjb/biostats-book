# 14. The t distribution {.unnumbered #t}
...
:::fyi
**You may see Z-tests in the literature.** Z tests are 100% correct, because we never have a population. But, in many cases a Z-test  is not meaningfully "wrong". As sample sizes get large, the t- and Z- distributions converge, and so they will give essentially the same answer. For convenience you may see people use the Z test in such cases, and that's fine by me.
