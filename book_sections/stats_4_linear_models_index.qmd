...
- [Chapter 18](#anova) shows how we can use the variance partitioning approach to evaluate caes in which there are more than two levels in the ordinal predictor. 

- With these tools in place we can now build models with a numeric explanatory variable ([Chapter 19](#regression)), multiple explanatory variables ([Chapter 20](#multiple_regression)),  and cases in which the repsonse is influenced by interactions between explanatory variables ([Chapter 21](#interactions))! 
