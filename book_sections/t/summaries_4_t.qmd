## • 15. Data summaries for t {.unnumbered #summaries_4_t}
...
- **The standard deviation:** A measure of spread, $s =\sqrt{\frac{\Sigma(x_i-\bar{x})^2}{n-1}}$.    
- **Cohen's D:** A standardized measure of effect size, $D = \frac{\bar{x}-\mu_0}{s}$. 


::: aside
We introduced Cohen's D in the [associations section](#associations), but is can be used for a single numeric variable as well!      
:::
