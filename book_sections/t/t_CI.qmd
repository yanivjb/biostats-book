...
- The sample standard deviation ($s$) divides the sum of squared deviations from the estimated population mean ($\Sigma (x_i - \bar{x})^2$) by $n - 1$  and then finds the quare root.    
