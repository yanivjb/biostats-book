## • 15. One sample t-test in R  {.unnumbered #one_sample_t_test_in_R}
...
The [`lm()`](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/lm.html) function in `R` builds such linear models. If we are only modeling the mean, the syntax is:     
