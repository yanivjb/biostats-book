## • 14. The paired t-test  {.unnumbered #paired_t_test}
...
1. Because Cohen's D is in th "tiny" (0.01 – 0.20) range, even if the estimated effect was true, it woud not be particularly  strong.   
