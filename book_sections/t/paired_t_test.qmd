...
:::aside 
**The next chapter introduces the two-sample t-test.** Although the two-sample t-test is usually less powerful than a paired t-test when true pairing exists, the teo-sample t-tesst is useful because it can be applied when data are not paired. 
:::
