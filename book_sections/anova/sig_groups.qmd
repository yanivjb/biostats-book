## •  18. Significance groups {.unnumbered  #sig_groups}
...
As you might imagine, logic-ing this all out can get messy. Luckily, you can pipe your [`glht()`](https://search.r-project.org/CRAN/refmans/multcomp/html/glht.html) output into the [`cld()`](https://search.r-project.org/CRAN/refmans/multcomp/html/cld.html) function which will  assign categories to "significance groups":
