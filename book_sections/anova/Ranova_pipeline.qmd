## •  17. R ANOVA pipeline  {.unnumbered  #Ranova_pipeline}
...
The [`tidy()`](https://broom.tidymodels.org/reference/tidy.lm.html) function in the [`broom`]([`broom`](https://broom.tidymodels.org/index.html) package makes this output tidy and shows our p-values are identical!
