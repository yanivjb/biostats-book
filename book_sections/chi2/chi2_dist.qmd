## • X6. $\chi^2$ distribution {.unnumbered #chi2_dist}
...
- **Understand how the mathematical $\chi^2$ distribution relates to a permutation-based approach**, and when you can (or cannot) use this distribution for a $\chi^2$ test.
...
4. **Compared our observed $\chi^2$** to this simulated null distribution to obtain a p-value and conduct a null hypothesis significance test (NHST). Approximately 29.4%  of our null simulation-based $\chi^2$ values were greater than or equal to our observed value of 10.46. Because the $\chi^2$ encompasses all types of deviations from null expectations, this is a one-tailed test. Our p-value is 0.294, and we fail to reject the null hypothesis.
...
:::note
**THINK:** Both our $\chi^2$ values were approximately 10. Why did we comfortably reject the null in this case and fail to reject it in the other? 
