## • X6. What to expect {.unnumbered #expectations_and_differences}
...
- Calculate a $\chi^2$ value as a test statistic to quantify  deviations between observations and expectations.
...
So for our case, $\text{Cohen's w} = \sqrt{\frac{10.462}{41}} = \sqrt{\frac{1}{4}}=\frac{1}{2}$. This is a borderline large effect!  
