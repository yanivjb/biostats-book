...
**Q3)** Which makes it easiest to compare survive probabilities of a males om fist clss vs the crew? `r mcq(c("dodge", answer = "fill", "stack"))`. 
...
- **Q4e)**  Survived, conditional on being in 1st class (i.e. the proportion of males in the creq who survived),  (i.e. P(Survive | Crew))? `r fitb(num = TRUE, answer = 0.223, tol = 0.027)` </br></br>
