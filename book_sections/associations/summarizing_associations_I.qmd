...
**Alternative formats:** 🎥 [Watch](https://drive.google.com/file/d/1JuGyjlicU3dXFIyWKjnfKJTuKWgtk4Zh/view?usp=drive_link) &nbsp;·&nbsp; 🎧 [Listen](../../audio/intro_to_r/associations_I/associations_I_summary.mp3)
:::
...
**Q3)** Which makes it easiest to compare survival probabilities of males in first class vs. the crew? `r mcq(c("dodge", answer = "fill", "stack"))`. 
...
## 📊 Glossary of Terms   {#summarizing_associations_glossary-of-terms_I}  
...
## Key R Functions {#summarizing_associations_key-r-functions_I}  
...
## R Packages Introduced     {#summarizing_associations_r-packages-introduced_I}    
...
## Additional resources   {#summarizing_associations_additional-resources_I}              
...
- [Probability Part 1: Rules and Patterns: Crash Course Statistics #13](https://www.youtube.com/watch?v=OyddY7DlV58): Covers the multiplication rule and conditional probability -- the same ideas behind conditional proportions in this chapter.  

- [Degrees of Freedom and Effect Sizes: Crash Course Statistics #28](https://www.youtube.com/watch?v=Cm0vFoGVMB8): Covers effect size more broadly, building on what you learned here about Cohen's D.  

- [StatQuest: Cohen's D](https://www.youtube.com/watch?v=rKkI45rPYiQ): A clear, focused walkthrough of Cohen's D specifically.  
