...
**Q6)** What is the first column in the diabetes dataset that will change its name after going through the clean_names() function?: `r fitb(answer = "stab.glu")`
...
:::exercises
**Q7)** The script above worked fine on my computer yesterday, but today I opened up a new R session on the very same computer and it failed. What went wrong? `r mcq(c("I set my working directory", "I used an absolute path, not a relative path",answer = "I did not load the libraries in my script", "I used the View function"))`

---

**Q8)** what about the script would make it work on my computer (once the thing above is fixed) but not on another computer? `r mcq(c(answer = "I set my working directory", "I used an absolute path, not a relative path", "I did not load the libraries in my script", "I used the View function"))`

---

**Q9)** What about the script is annoying for someone using this code (once it works) and should be removed, but doesnt stop our code from working? `r mcq(c( "I set my working directory", "I used an absolute path, not a relative path", "I did not load the libraries in my script",answer = "I used the View function"))`
::: 
