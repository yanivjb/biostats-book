...
**Alternative formats:** 🎥 [Watch](https://drive.google.com/file/d/1Yj_Nhqx_DvAKtDPF_-wKJNlz8edafKk1/view?usp=drive_link) &nbsp;·&nbsp; 🎧 [Listen](../../audio/intro_to_r/reproducible_science/load_data.mp3)
:::
...
path     <- "https://github.com/yanivjb/biostats-book-data/raw/refs/heads/main/clarkia_rils.xlsx"
...
A **relative path** describes the location of a file relative to your `.Rproj` file. For example:

```{r}
#| eval: false
read_csv("data/clarkia_rils.csv")
```
Relative paths make your work easier to share: the code will work on anyone’s computer as long as they have the same project folder and file structure.

In contrast, an **absolute path** gives the file’s full location on one computer. For example:

```{r}
#| eval: false
read_csv("/Users/ybrandvain/Desktop/clarkia_reinforcement/data/clarkia_rils.csv")
```


That path will work on my computer but probably not on yours.
...
**If you have never encountered `setwd()`,** congratulations—you can stop reading! If you have used it to change your working directory, avoid it here. It can behave unpredictably on someone else’s computer, making your work less reproducible. I would also hate for [Jenny Bryan to set your computer on fire](https://tidyverse.org/blog/2017/12/workflow-vs-script/).
