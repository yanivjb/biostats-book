## • 8. Sampling Bias {.unnumbered #sampling_bias}
...
This is a form of **"volunteer" bias**. As shown in @fig-volunteer, this problem is especially common in surveys where the people who choose to respond are rarely representative of the entire population. The same principle applies in other contexts: e.g. it's likely easier to catch a slow mouse than a fast one, which would lead to a biased sample of animal behavior. 
...
Changing the question so it is statistically valid may help us feel better, but leaves the initial question unanswered. For example, we want to know how likely planes are to get hit in the cockpit, making the question about wings does not solve this.
:::
