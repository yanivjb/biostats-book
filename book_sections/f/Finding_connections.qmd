## •  16. *F*-inding connec*t*ions  {.unnumbered  #finding_connections}
...
**Motivating Scenario:**
In the previous chapter we compared two groups using as two-sample t-test. In this chapter, we basically did the same thing as an ANOVA. You want to know the relationship between these approaches.
