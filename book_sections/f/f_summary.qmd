## • 16. F (ANOVA) summary {.unnumbered #f_summary}
...
Links to: [Summary](#f_summary_chapter-summary). [Chatbot tutor](#f_summary_chatbot_tutor).  [Questions](#f_summary_practice-questions). [Glossary](#f_summary_glossary-of-terms). [R packages](#f_summaryR_packages_introduced). [R functions](#f_summary_key-r-functions). [More resources](#f_summary_additional-resources).
