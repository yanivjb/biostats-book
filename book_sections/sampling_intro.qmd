# 8. Intro to Sampling {.unnumbered #sampling_intro}
...
**Motivating Scenario:** You've collected data and generated some nice plots and summaries, but you know this is just the beginning.  You realize that this is just one sample, and that the same study done again could lead to different estimates and conclusions. You need a framework for understanding and quantifying the uncertainty that comes from this process of sampling.
