...
**Motivating scenario:** We fit a model with an interaction, and this interaction seems to influence our predictions. Now we want to test the null hypothesis that the interaction (and main effects)  relect only sampling error rather than a real effect.
