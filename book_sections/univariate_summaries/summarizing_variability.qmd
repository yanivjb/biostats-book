...
Or we can skip the formulae and just use standard R functions, [`var()`](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/cor.html) and [`sd()`](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/sd.html). We can even find the mean absolute difference with as  
`mean(abs(x - mean(x)))`, and the median absolute difference with the  [`mad()`](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/mad.html) function.
