...
- Of course, distributions can have more than two modes. **Trimodal distributions** have three peaks, and so on. However, be careful not to over-interpret small fluctuations—small dips can create false peaks from random variation. It's worth experimenting with bin size to avoid overinterpreting such small blips.
