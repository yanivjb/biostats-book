...
**Q9** What is wrong with the code below (pick the most egregious issue). `r longmcq(c(answer = "I overwrote iris and lost the raw data", "I did not show the output", "I used summarise() rather than summarize()",  "I did not tell R to remove missing data when calculating the mean."))`
