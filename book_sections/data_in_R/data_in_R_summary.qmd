...
- **[`dplyr::filter()`](https://dplyr.tidyverse.org/reference/filter.html)** *([dplyr](https://dplyr.tidyverse.org/). Because there is a different filter in a different package, always specify which filter you want r to use.)*: Only retains rows wihich meet some logical criteria.   
