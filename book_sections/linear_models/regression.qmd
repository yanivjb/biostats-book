## • 12. Linear regression {.unnumbered #linear_regress}
...
- The value of the explanatory variable was zero for plant sin the reference group and 1 for plants in the other group.
