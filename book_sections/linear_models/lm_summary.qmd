...
- **Residual Standard Deviation**: A measure of typical residual size — how far off predictions tend to be $\sqrt{\frac{\sum e_i^2}{n-k}}$, where $k$ is the number of parameters estimated in our model. For a simple linear regression $k=2$, as we estimate the slope slope and the intercept.
