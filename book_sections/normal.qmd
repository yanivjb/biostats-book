# 13. Normal distribution {.unnumbered #normal}
...
If you want even more, I include an optoinal chapter on [simulating data from a normal distribution](#noRmal) to verify the mathematical properties of the normal to build a deeper intuition for the sampling process.