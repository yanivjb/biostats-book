...
**Motivating Scenario:** You can  bootstrap yourself with [`slice_sample()`](https://dplyr.tidyverse.org/reference/slice.html), but it's tedious. You would rather use a simple R package that works for man different estimates and does the hard bits for you.
