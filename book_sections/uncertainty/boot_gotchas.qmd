## • 9. Gotchas  {.unnumbered #boot_gotchas}
...
**Bootstrapping is great!** By bootstrapping, we can estimate uncertainty without relying on formulas or assumptions about the distribution of the data. But, as with all stats tools, there are limits to the use of bootstrapping. So before moving onto the next section, I present these limits and how to deal with them.
...
Bootstrapping works by approximating the sampling distribution by resampling your data with replacement. Thus it inherently assumes your sample is a good representation of the population. A very small sample is unlikely to  capture the true shape of the population's distribution. 
...
3. A quarter of the time we will sample individual two twice and their value will be the estimate of the mean. 

These three possibilities do not accurately capture the extent of our uncertainty.  
