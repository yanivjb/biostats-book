...
**Bootstrapping is great!** It allows us to estimate uncertainty without relying on formulas or strong distributional assumptions. But as with all stats tools, there are limits to the use of bootstrapping. So before moving onto the next section it is worth going over   these limits and how to deal with them.
