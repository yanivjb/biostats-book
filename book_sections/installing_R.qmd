...
After installing `R` download/update the RStudio IDE from [Posit's download site(https://docs.posit.co/ide/user/#rstudio-ide-oss-downloads).

After downloading R, and then RStudio, open RStudio. It should look like this:
