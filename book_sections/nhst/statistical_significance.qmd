## • 10. Statistical Significance {.unnumbered #statistical_significance}
...
**Motivating Scenario:** You now can calculate a p-value and know what it means. But what do you do now? How do you present and report these results, especially when you feel the need to make a clear decision about a trend.
...
**So what do scientists do with a p-value?** A p-value itself is an informative summary -- it tells us the probability that a random draw from the null distribution would generate data as or more extreme than what we observed. 
...
**By convention we never accept the null hypothesis -- we simply fail to reject it.** The reason for this is that we know that the null may still be incorrect. In fact, the same effect size in a larger study would have more power to reject the null. 
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="background-color: #d3f8d3;">Reject false null hypothesis <br> Occurs with probability 1 - β  <br> (aka Power) This is the correct decision</td>
    </tr>
  </tbody>
</table>
