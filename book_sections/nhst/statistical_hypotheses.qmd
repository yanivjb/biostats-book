...
The **Alternative Hypothesis ($H_A$ or $H_1$)** is the claim that the null hypothesis is not true.  It claims that something other than random sampling error is responsible for the observed pattern.    This is a vague, so the alternative hypothesis is not making a specific claim -- rather  it's a grab bag for all ways the null could be wrong. 
