...
The **Alternative Hypothesis ($H_A$ or $H_1$)** is the claim that the null hypothesis is not true.  It claims that something other than random sampling error is responsible for the observed pattern.    This is a vague statement, so the alternative hypothesis is not making a specific claim -- rather  it's a grab bag for all ways the null could be wrong. 
...
- Above, we conducted a **two-tailed test** of the null hypothesis. According to this, standard practice, the null is that  proportions "differ" between white and pink morphs. It did not  specify a direction. In a two-tailed test, we are open to the effect going in either direction. 
