## • X1. Avoid Distractions {.unnumbered #avoid_distractions}  
...
#| echo: false
#| label: fig-slipper
#| fig-cap: "A [tweet from the *Calling Bullshit* highlights a 'glass slipper'](https://twitter.com/callin_bull/status/1106259105377705985). This  'Periodic Table of IT Ops Tools' mimics the structure of the chemical periodic table but does not reflect any real periodicity or organizational logic in the data it presents."
...
include_graphics("../../figs/summarizing_data/data_viz/periodic_table.png")
```
