...
:::protip
**Plots as "Brown M&Ms"**     
The hard rock band Van Halen had a strange issue in their "rider." They insisted on having a bowl of M&Ms but no brown M&Ms (@fig-mandm). Although they had a very rock-band diva response when this contractual obligation was not fulfilled (see the quote o the right), this request served a real purpose. As [explained by vocalist David Lee Roth](https://www.youtube.com/watch?v=_IxqdAgNJck) this request was a way to ensure that the  venue had closely read the requirements for the show to ensure safety (as alluded to at the end of the Wikipedia quote).
