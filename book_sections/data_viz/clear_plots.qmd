## • X1. Clear plots {.unnumbered #clear_plots}
...
- **c** Rotates the labels 90 degrees. This too is helpful, but we rarely read at this angle.   
...
:::fyi
Maintaining consistency in color mapping, as shown in @fig-consistent c, and sorting labels sensibly makes plots even easier to process.
:::
