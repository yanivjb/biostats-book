## • X1. Writing about plots {.unnumbered #writing_about_figures}
...
**Motivating Scenario:** You (think you've) just made a great figure. Now it's time to write about it. What do you do now? 
...
| -------- | ------- |
| "Stacked bar plot showing the COVID vaccine works." | "Stacked bar plot showing COVID cases by severity for placebo and mRNA-1273 groups. The placebo group has many more cases, including severe ones (dark blue), while the vaccinated group has only a few mild cases (light blue)." |
