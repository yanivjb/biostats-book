...
- **Cohen's D** as the difference in means standardized by the pooled standard deviation. Cohen's D $=\frac{\text{mean diff}}{s_p}$ $=\frac{1.03}{\sqrt{1.833}}$ $=\frac{1.027}{1.35}$   $= 0.76$.  This is considered a medium (borderline large) effect, so it likely matters (if true). 
