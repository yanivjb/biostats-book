...
::: {.callout-note}
Recall that even though these data don't fully meet assumptions, that doesn't automatically mean we can't trust the results. Whether a violation matters depends on how robust the test is to it, and the t-test is generally super robust to modest violations like those in these data. But to be safe, I'll also conduct NHST with a permutation test, and estimate uncertainty with a bootstrap later. 
:::
