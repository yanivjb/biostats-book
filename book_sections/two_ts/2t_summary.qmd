...
**Q10A)** If all I knew was that $t \approx  1$, but did not kow the degrees of freedom, would I be able to reject the null at $\alpha = 0.05$? `r mcq(c("Yes", answer = "No","Can't tell you without the degress of freedom."))`

**Q10B)** Say for a different dataset I knew that $t = 2$ (rather than one) but did not kow the degrees of freedom, would I be able to reject the null at $\alpha = 0.05$? `r mcq(c("Yes","No",  answer =  "Can't tell you without the degrees of freedom."))`
