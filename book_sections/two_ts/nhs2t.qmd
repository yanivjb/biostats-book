...
In the previous section, we calculated a difference between pink- and white- petaled RILs at site SR of $1.76 - 0.733 \approx 1.03$.  We also quantified uncertainty about this estimate as a standard error of 0.262. Recalling the equation for the t-statistic:
...
Since we had  105 degrees of freedom, the critical t-value will be just a hair greater than 1.96. So, the observed t-value of $\approx 4$ is way bigger than our critical t-value of $\approx 2$. As such, we strongly reject the null hypothesis that pink- and white-flowered *Clarkia xantiana subspecies parviflora* RILs at site SR are visited equally by pollinators.  
