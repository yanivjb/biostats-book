...
The violations here are relatively minor. If it were my analysis, I would do a Welch's t-test (i.e. not assume equal variance), because this test is almost always better than the standard t-test. I would not transform the data, because that makes things harder to interpret. But, to ensure that the violations of assumptions aren't misleading me (and to gain the trust of my readers), I would follow up with a permutation and bootstrap.