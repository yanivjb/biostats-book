...
#| column: margin
#| echo: false
#| fig-cap: "Bootstrap sampling distribution of the difference in mean visits (pink − white). The histogram shows 50,000 bootstrapped estimates of the mean difference; the red vertical lines mark the 95% percentile CI (here ≈ 0.5 to 1.5)."
#| fig-alt: "A histogram of 50,000 bootstrap estimates of the difference in mean pollinator visits between pink and white RILs (pink - white). The distribution is centered near 1.0, with most mass between roughly 0.5 and 1.5. A dashed vertical line can mark the observed sample difference."
#| label: fig-boot_x
library(infer)
library(tidyr)
raw_diff <- SR_visits %>%
