...
#| fig-alt: "Another screenshot of the RStudio interface. Now 1 + 1 is entered at the bottom of the console pane. The pane displays the answer, 2, and the top right pane recordd the history of what we asked R (it now shows 1+1)."
