...
5. Write an R Script & recognize best practices in writing scripts.
5. Know your way around RStudio.
...
**Alternative formats:** 🎥 [Watch](https://drive.google.com/open?id=1XfdD5I9jngjN_vWDaIErRaQHNk0QQs0f&usp=drive_copy) &nbsp;·&nbsp; 🎧 [Listen](../audio/intro_to_r/getting_started/1_Getting_Started_with_R.mp3)
:::
...
::: {.callout-important}
Now is probably a good time to download R and RStudio or get setup using RStudio on the cloud. Check the resource about [Installing R & RStudio](#R-install) in the back of the book for help.
:::
