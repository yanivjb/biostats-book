...
**Alternative formats:** 🎥 [Watch](https://drive.google.com/file/d/1g8dAYYYkuEYT-EWueunW_r-d61zRQqDb/view) &nbsp;·&nbsp; 🎧 [Listen](../../audio/intro_to_r/getting_started/1_Vectors_and_other_objects.mp3)
:::
...
**R handles different types of data in specific ways**. Understanding these data types is crucial because what you can do with your data depends on how R interprets it. For example, although you know that `1 + "two"` should equal three, R cannot add a number and a word.  Understanding this will help you understand `R`'s error messages and confusing results when things don't work as expected. 

So, the common types of vectors are:  
