...
**Alternative formats:** 🎥 [Watch](https://drive.google.com/file/d/1XfdD5I9jngjN_vWDaIErRaQHNk0QQs0f/view?usp=drive_link) &nbsp;·&nbsp; 🎧 [Listen](../../audio/intro_to_r/getting_started/1_Getting_Started_Summary.mp3)
:::
...
:::tutor   
Please interact with this custom chatbot ([**ChatGPT link here**](https://chatgpt.com/g/g-680a5b27740c8191b9cb63d729dc29fe-getting-started-with-r-tutor), [**Gemini link here**](https://gemini.google.com/gem/1NE4tGoNgsLBErBvNQaeZMq9ZyDBBczQ6?usp=sharing)) I have made to help you with this chapter. I suggest interacting with at least ten back-and-forths to ramp up  and then stopping when you feel like you got what you needed from it.   
:::
...
#| fig-cap: "An [xkcd comic](https://xkcd.com/3228/) about floating point issues. Rollover text said \"It has been −2,147,483,648 days since our last integer overflow.\". See [explain xkcd](https://www.explainxkcd.com/wiki/index.php/3228:_Day_Counter) for more info."
#| fig-alt: "An xkcd comic. White Hat, Ponytail, Cueball, and Megan are all below a large sign, which appears to be attached to the wall at its four corners. White Hat and Ponytail appear to be discussing something, while Cueball is sitting at his desk working on a laptop and Megan is walking away. The sign has text on it, as well as a large display presumably meant to show a number. A sign says it has been -0.00000000000000044 days since our last floating point error."
include_graphics("https://imgs.xkcd.com/comics/day_counter_2x.png")
```
...
Use the data in the table below for the next question (each column is a leaf). For your convenience I have included a web-r workspace: 
...
The mean leaf area is `r fitb(16.89916, tol = .15)`
...
**Q4)** How will running the script in @fig-praise (above) make you feel?   `r mcq(c("Amazing, I love being praised", answer = "Not good, it won't work :("))`
...
:::exercises
**Q9)** Consider the lines of  code above, which two are best to include in your saved R script (assuming you are using functions from ggplot2)? `r longmcq(c("a & b",  "a & c", answer = "a & d", "b & c", "b & d", "c & d"))`
...
:::exercises
**Q10)** Which of the following is the best long-term strategy for improving in R?
...
- **[`praise`](https://github.com/rladies/praise)**: Provides encouragement  and kind words.
...
- [Data types](https://vimeo.com/747009618) (Yaniv Talking).  Uses [compensation data](https://raw.githubusercontent.com/ybrandvain/datasets/master/compensation.csv) as an example.     
