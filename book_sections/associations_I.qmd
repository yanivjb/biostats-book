...
2. **Explain and interpret summaries of associations between a binary explanatory variable and wither a continuous or binary response variable.**    
   ...
   - Describe an association between a binary explanatory variable and a continuous response 
       ...
       - As an "effect size".   
   - Describe associations between two binary variables.  
       - Find expected joint probabilities by the "multiplication rule".  
       - Use the deviation from this expectation to quantify "covariance."   
