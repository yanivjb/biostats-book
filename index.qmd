...
Any results we observe is shaped by a combination of random chance, the thing we care about, and things we ignored and do not necessarily care about.  Identifying subtle biases and non-independence is key to conducting and interpreting statistics.
...
I start by assuming you know nothing about R or statistics (I know this assumption is wrong -- many of you all know a lot!). From this humble beginning I aim to leave you with the skills to conduct standard statistical analyses, and the understanding of statistics and the ability to go beyond what we have learned.  We take the following path in @fig-path, below:
...
-   [**German Vargas Gutierrez**](https://bpp.oregonstate.edu/users/german-vargas-gutierrez):  German was one of my early TAs. He's fantastic, and helped me think about how to do and teach stats. 

-   [**Chaochih Liu**](https://en.wikipedia.org/wiki/Chaochih_Liu): Chaochih contributed greatly to the course's organization and structure.
...
-   [**Brooke Kern**](https://www.bellmuseum.umn.edu/grad-awards/2021-graduate-award-and-fellowship-recipients/brooke-kern/): Brooke was both a great TA AND a great collaborator. Much of the data in this come from Brooke's dissertation.\


-   [**Brooke Kern**](https://www.bellmuseum.umn.edu/grad-awards/2021-graduate-award-and-fellowship-recipients/brooke-kern/): Brooke was both a great TA AND a great collaborator. Much of the data in this come from Brooke's dissertation.

-  **Abigail Meyer**. Again - I got super lucky. Abigail is  great.  

- **Achala Narayanan**. Achala is a fantastic statistician, scientist and teacher. The students and I were lucky to have her help!
...
This book is not done. I  need to 



- Add "design" notes in every linear model chapater.  
- Add power and precision to each linear models chapter. 
- Write chapter on model evaluation
- Write chapter on Causal Inference 
- Add good plots chapter + good plots in R
- Add using chatbots chapter
- Add using agents chapter
- Straighten out goals of stats (compare linear model intro to design) (5 or three, what are they...).
- Add an appendix on data munging.  
